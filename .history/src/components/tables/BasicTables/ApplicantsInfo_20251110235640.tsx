...
interface Order {
  ...
  email: string;
  status: string;
  age: number; // Used for calculated age
        ...
        const fetchedData: Order[] = querySnapshot.docs.map(doc => {
          ...
          return {
            ...
            user: {
              ...
              // Note: Role is not in the data, default to Applicant
            ...
            age: 0, // Age is calculated in the modal, but initialized here
            // ⭐ Mapped Birthdate and Gender
