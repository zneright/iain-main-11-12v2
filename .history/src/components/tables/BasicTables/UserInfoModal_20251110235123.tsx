...
interface Order {
  ...
  email: string;
  status: string;
  age: number; // Placeholder for calculated age if needed
  gender: string;
  address: string;
...
export default function UserInfoModal({
  ...
  // Destructure all available fields, including birthDate
  const { user, email, phone, age, gender, address, birthDate } = order;
