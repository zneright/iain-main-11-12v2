...
import { useState, useEffect } from "react"; import { collection, getDocs } from "firebase/firestore";
...
export default function ApplicantsInfo() { // Renamed the export function
