...
import EditStatusModal from "../../tables/BasicTables/EditStatusModal";
...
interface Order {
  id: string;
  user: {
    // ⭐ ADDED: profileImageUrl is the source for the image
    image: string;
    name: string;
    role: string;
  };
    ...
    const fetchAccounts = async () => {
      ...
      try {
        ...
        const fetchedData: Order[] = querySnapshot.docs.map(doc => {
          ...
          // ⭐ ACTION 1: Get the profile image URL from Firestore
          const imageUrl = data.profileImageUrl || '/images/applicants/default-user.jpg';
          ...
          return {
            ...
            user: {
              ...
              // ⭐ ACTION 2: Use the fetched URL for the image source
              image: imageUrl,
            },
                    ...
                    >
                      <div className="w-10 h-10 overflow-hidden rounded-full">
                        <img
                          width={40}
                          height={40}
                          // ⭐ ACTION 3: Use the fetched URL as the image source
