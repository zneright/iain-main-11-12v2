...
interface Order {
  ...
  status: string;
  age: number;
  // ⭐ ADDED: Birthdate and Gender to the interface
  birthDate: string;
  gender: string;
...
export default function ApplicantsInfo() {
      ...
      try {
        ...
        const fetchedData: Order[] = querySnapshot.docs.map(doc => {
          ...
          return {
            ...
            age: data.age || 0,
            // ⭐ MAPPED: Birthdate and Gender from Firestore data
  ...
  return (
    <div className="overflow-hidden rounded-xl border border-gray-200 bg-white dark:border-white/[0.05] dark:bg-white/[0.03]">
      ...
      {/* UserInfoModal will now receive and display birthDate and gender */}
      <UserInfoModal
