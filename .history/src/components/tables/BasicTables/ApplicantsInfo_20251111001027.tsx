...
// ⭐ ASSUMPTION: Assuming these modals are imported from their correct, separate file paths.
import EditStatusModal from "../../tables/BasicTables/EditStatusModal"; // <-- CHANGE 1: Must be the path to the Status Modal file
import UserInfoModal from "../../tables/BasicTables/UserInfoModal";    // <-- CHANGE 2: Must be the path to the Info Modal file
...
export default function ApplicantsInfo() {
  ...
  const handleEditClick = (order: Order) => {
    ...
    setOpenStatusModal(true); // ⬅️ THIS IS THE CRITICAL LINE THAT MUST EXECUTE
  };
