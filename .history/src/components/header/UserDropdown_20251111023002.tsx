    ...
    <div className="relative">
      ...
      >
        ...
        <ul className="flex flex-col gap-1 pt-4 pb-3 border-b border-gray-200 dark:border-gray-800">
          <li>
            {/* ⭐ FIX: Wrap DropdownItem content inside the Link element */}
            <Link
              to="/profile"
              onClick={closeDropdown} // Close dropdown on navigation
              className="w-full" // Ensure the Link fills the space
            >
              <DropdownItem
                onItemClick={() => { }} // Pass empty function to prevent redundant closing
                className="flex items-center gap-3 px-3 py-2 font-medium text-gray-700 rounded-lg group text-theme-sm hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300"
              >
                {/* SVG for Edit Profile / Settings Icon */}
          ...
          <li>
            <DropdownItem
              ...
              className="flex items-center gap-3 px-3 py-2 font-medium text-gray-700 rounded-lg group text-theme-sm hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300"
            >
              {/* SVG for Support (Cleaned) */}
              <svg className="fill-gray-500 group-hover:fill-gray-700 dark:fill-gray-400 dark:group-hover:fill-gray-300" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        >
          {/* SVG for Sign out (Cleaned) */}
          <svg className="fill-gray-500 group-hover:fill-gray-700 dark:group-hover:fill-gray-300" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
