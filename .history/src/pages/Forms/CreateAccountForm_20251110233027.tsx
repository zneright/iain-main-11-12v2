    ...
    <div>
      ...
      <form onSubmit={handleCreateAccount}>
        <div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
          ...
          {/* RIGHT COLUMN: Address Info and Button (previously AddressInfo) */}
          <div className="space-y-6">

            {/* --- Address Info --- */}
            <div className="component-card"> {/* Simulate AddressInfo */}
            ...
            <div className="flex items-center gap-5 justify-end">
              <Button
                type="submit" // ⬅️ IMPORTANT: Set type="submit" to trigger handleCreateAccount
                size="md"
                variant="primary"
                disabled={loading}
              >
