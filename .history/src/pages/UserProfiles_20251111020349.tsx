...
const CLOUDINARY_UPLOAD_PRESET = "YOUR_UPLOAD_PRESET"; // Replace YOUR_UPLOAD_PRESET
const DEFAULT_LOGO_URL = "/images/admin/default-company-logo.svg"; // Fallback image
