...
interface Notification {
  ...
  title: string;
  description: string;
  category: string; // Type (e.g., Interview, Reminder)
  time: string; // Formatted time ago
  read: boolean;
  scheduledDate: string;
  scheduledTime: string; // Time string (e.g., "14:00")
...
// ⭐ NEW HELPER: Converts 24-hour time string ("14:30") to 12-hour format ("2:30 PM")
const formatTime12Hour = (time24: string): string => {
  ...
  try {
    ...
    const hour12 = hours % 12 || 12; // Converts 0 (midnight) or 12 (noon) to 12
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-700 dark:text-gray-300">
                    ...
                    <span className="text-sm italic text-gray-600 dark:text-gray-400">
                      ...
                      {/* ⭐ ACTION: Use the 12-hour format helper */}
                      {notif.scheduledTime && ` at ${formatTime12Hour(notif.scheduledTime)}`})
                    </span>
                  </p>
                  ...
                  <div className="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
                    {/* This span now shows the Notification Type (e.g., Interview) */}
