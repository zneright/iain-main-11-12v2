...
// FIREBASE IMPORTS
// -------------------------------------------------------------------------
// Imports doc, updateDoc, and getDoc for targeted lookup
...
interface Notification {
  id: string;
  name: string; // Source user/system (maps to data.sourceUser or data.title)
  title: string;
  description: string;
  category: string;
  ...
  // ⭐ RECIPIENT FIELDS: Fetched via lookup using targetUid
...
export default function NotificationsPage() {
  ...
  // =================================================================
  // 🎯 FIREBASE FETCH LOGIC (With Applicant Lookup)
  // =================================================================
...
You may want to learn more about structuring data in Firebase. [Structuring Data in Firebase Realtime Database](https://www.youtube.com/watch?v=LaGYxQWYmmc) This video explains how to organize JSON data in Firebase, which is fundamental to performing efficient lookups like the one implemented here.