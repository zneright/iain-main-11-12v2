...
interface Notification {
  ...
  name: string; // Source user/system
...
const formatScheduledDate = (dateString: string): string => {
  ...
  // Check if the date is valid (new Date('2025-11-11').toString() is usually valid)
    ...
    try {
      ...
      const fetchedNotifs: Notification[] = querySnapshot.docs.map(doc => {
        ...
        return {
          ...
          time: formatTime(createdAtDate), // ⭐ USING IMPROVED formatTime
              ...
              >
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
                    ...
                    <span>{notif.time}</span> {/* ⭐ USING IMPROVED TIME AGO */}
                  </div>
                </div>
