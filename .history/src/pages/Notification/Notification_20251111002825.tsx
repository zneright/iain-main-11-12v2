  ...
  export default function NotificationsPage() {
      ...
      try {
        ...
        const fetchedNotifs: Notification[] = querySnapshot.docs.map(doc => {
          ...
          return {
            ...
            // ⭐ REFINED MAPPING: Use title and description fields directly
    ...
    const markAllAsRead = () => {
      // NOTE: Does not update Firestore for simplicity, only local state
      setNotifications((prev) => prev.map((n) => ({ ...n, read: true })));
    };

    const clearAll = () => {
      // NOTE: Does not delete from Firestore for simplicity
      setNotifications([]);
    };
